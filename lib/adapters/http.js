...
function HttpPouch(opts, callback) {
  ...
  api.compact = function (opts, cb) {
    ...
    return new Promise(function (fulfill, reject) {
      ...
      if (!api.taskqueue.ready()) {
        api.taskqueue.addTask('compact', [opts, callback]);
        return;
      }
      ajax({
        headers: host.headers,
  ...
  api.info = function (cb) {
    return new Promise(function (fulfill, reject) {
      ...
      if (!api.taskqueue.ready()) {
        api.taskqueue.addTask('info', [callback]);
        return;
      }
      ajax({
        headers: host.headers,
  ...
  api.get = function (id, opts, cb) {
    ...
    return new Promise(function (fulfill, reject) {
      ...
      if (!api.taskqueue.ready()) {
        api.taskqueue.addTask('get', [id, opts, callback]);
        return;
      }
  ...
  api.remove = function (doc, opts, cb) {
    ...
    return new Promise(function (fulfill, reject) {
      ...
      if (!api.taskqueue.ready()) {
        api.taskqueue.addTask('remove', [doc, opts, callback]);
        return;
      }
      // Delete the document
      ajax({
  ...
  // Get the attachment
  api.getAttachment = function (docId, attachmentId, opts, cb) {
    if (typeof opts === 'function') {
      cb = opts;
      opts = {};
    } else if (typeof opts === 'undefined') {
  ...
  api.removeAttachment = function (docId, attachmentId, rev, cb) {
    return new Promise(function (fulfill, reject) {
      function callback(err, mesg) {
        if (typeof cb === 'function') {
          cb(err, mesg);
      ...
      if (!api.taskqueue.ready()) {
        api.taskqueue.addTask('removeAttachment', [docId, attachmentId, rev, callback]);
        return;
      }
      ajax({
        headers: host.headers,
  ...
  api.putAttachment = function (docId, attachmentId, rev, blob, type, cb) {
    ...
    return new Promise(function (fulfill, reject) {
      ...
      if (!api.taskqueue.ready()) {
        api.taskqueue.addTask('putAttachment', [docId, attachmentId, rev, blob, type, callback]);
        return;
      }
  ...
  api.put = function (doc, opts, cb) {
    ...
    return new Promise(function (fulfill, reject) {
      ...
      if (!api.taskqueue.ready()) {
        api.taskqueue.addTask('put', [doc, opts, callback]);
        return;
      }
  ...
  api.post = function (doc, opts, cb) {
    ...
    return new Promise(function (fulfill, reject) {
      ...
      if (!api.taskqueue.ready()) {
        api.taskqueue.addTask('post', [doc, opts, callback]);
        return;
      }
      if (typeof doc !== 'object') {
        return utils.call(callback, errors.NOT_AN_OBJECT);
  ...
  // given by host.
  api.bulkDocs = function (req, opts, cb) {
    // If no options were given, set the callback to be the second parameter
    if (typeof opts === 'function') {
      cb = opts;
      opts = {};
    ...
    return new Promise(function (fulfill, reject) {
      ...
      if (!api.taskqueue.ready()) {
        api.taskqueue.addTask('bulkDocs', [req, opts, callback]);
        return;
      }
      if (!opts) {
        opts = {};
  ...
  api.allDocs = function (opts, cb) {
    ...
    return new Promise(function (fulfill, reject) {
      ...
      // If no options were given, set the callback to be the second parameter
      if (!api.taskqueue.ready()) {
        api.taskqueue.addTask('allDocs', [opts, callback]);
        return;
      }
  ...
  api.revsDiff = function (req, opts, cb) {
    // If no options were given, set the callback to be the second parameter
    if (typeof opts === 'function') {
      cb = opts;
      opts = {};
    ...
    return new Promise(function (fulfill, reject) {
      ...
      if (!api.taskqueue.ready()) {
        api.taskqueue.addTask('revsDiff', [req, opts, callback]);
        return;
      }
  ...
  api.close = function (cb) {
    return new Promise(function (fulfill, reject) {
      ...
      if (!api.taskqueue.ready()) {
        api.taskqueue.addTask('close', [callback]);
        return;
      }
      utils.call(callback, null);
    });
